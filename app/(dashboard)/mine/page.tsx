...
import { Pickaxe, Cpu, CircleDollarSign, ShieldCheck, Briefcase, ArrowRight, Loader2, Zap, Wallet, Cloud, Terminal, Wrench } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <Link
            href="/mine/runs"
            className="inline-flex items-center gap-1.5 rounded-[var(--radius-sm)] border border-border px-2.5 py-1.5 font-mono text-[10px] uppercase tracking-wider hover:bg-secondary"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded-[var(--radius-sm)] border border-border px-2.5 py-1.5 font-mono text-[10px] uppercase tracking-wider hover:bg-secondary"
          >
            <Wrench className="size-3" /> {t('mine.openHarness')}
          </Link>
        </div>
      </div>
