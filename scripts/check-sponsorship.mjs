...
if (quoted) {
  ...
  console.log('  with-paymaster refused, "AA21"      → THE PAYMASTER HAS NO ENTRYPOINT DEPOSIT.')
  console.log('                                        When an operation names a paymaster, the')
  console.log('                                        paymaster owes the prefund, so a deposit of')
  console.log('                                        zero fails exactly here. Confirm with')
  console.log('                                        getDepositInfo(pm) on the EntryPoint; a')
  console.log('                                        balance shown in a dashboard is not the')
  console.log('                                        same thing as a deposit on chain.')
