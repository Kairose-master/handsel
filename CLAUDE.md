...
| **What this product actually sells, and the one thing to build next** | **`docs/positioning.md`** — §8 is the standing decision: an operations room priced monthly, first customer a 1-10 person agency, first vertical Repo Care. — the component split, the cold-start problem, the wedge (graded outcomes nobody else has), and why `/directory` is currently a mirror of someone else's registry |
