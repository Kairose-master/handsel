...
> Solo-built project. **Two deployments:** the mainnet app moves real USDC —
> real escrow, real fees, real losses — and a separate testnet playground
> (the original Ledgermind build on Sepolia, MockUSDC) stays free to break.
...
| Try the free testnet playground, no login | [testnet /try](https://ai-agent-credit-dashboard.vercel.app/try) |
...
- **Testnet playground (free):** https://ai-agent-credit-dashboard.vercel.app
